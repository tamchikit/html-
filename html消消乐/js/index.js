var marks = 0;
alert("jeje生日快乐，送你一个属于你自己的消消乐，大个仔啦唔猴再玩甘多游戏知嘛");
...
$(function(){
 ...
 if(marks == 63){
	 var comment = window.prompt(["再说一次好玩吗"],);
	 while(true){
		 if(comment == "好玩"){
		     alert("我就知道好玩");
	    	 alert("我说过63分会有惊喜的");
	         ...
	         alert("那好吧，惊喜就是");
	         alert("jeje求求你做个人吧！");
	         window.location.href="http://chuye.cloud7.com.cn/57234191";
			 break;
	     }
	     if(comment == "不好玩"){
		     alert("不好玩吗？？？？我做了很久的呜呜呜呜，你没有生日惊喜了");
		     comment = window.prompt(["再说一次好玩吗"],);
	     } 
		 else{
			 comment = window.prompt(["好玩就是好玩不好玩就是不好玩嘛，哪来这么多花里胡哨五五六六七七八八的！！"],);
		 }
	 }
 }
 function addArr(aLi){
